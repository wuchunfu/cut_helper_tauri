...
; 自定义字符串
LangString CUT_HELPER_TITLE ${LANG_SIMPCHINESE} "剪切板助手"
LangString CUT_HELPER_DESCRIPTION ${LANG_SIMPCHINESE} "剪切板助手安装程序"
LangString CUT_HELPER_PUBLISHER ${LANG_SIMPCHINESE} "sallai"
LangString CUT_HELPER_WEB_SITE ${LANG_SIMPCHINESE} "https://github.com/sallai/cut_helper_tauri"

; 安装界面文本
LangString INSTALL_SUCCESS ${LANG_SIMPCHINESE} "安装完成！"
LangString UNINSTALL_SUCCESS ${LANG_SIMPCHINESE} "卸载完成！"
LangString INSTALL_FAILED ${LANG_SIMPCHINESE} "安装失败！"
LangString UNINSTALL_FAILED ${LANG_SIMPCHINESE} "卸载失败！"

; 选项文本
LangString CREATE_DESKTOP_SHORTCUT ${LANG_SIMPCHINESE} "创建桌面快捷方式"
LangString CREATE_START_MENU_SHORTCUT ${LANG_SIMPCHINESE} "创建开始菜单快捷方式"
LangString AUTO_START ${LANG_SIMPCHINESE} "开机自动启动"
